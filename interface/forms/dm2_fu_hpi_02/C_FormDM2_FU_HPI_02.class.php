...
require_once("FormDM2_FU_HPI_02.class.php");

use OpenEMR\Common\Csrf\CsrfUtils;

class C_FormDM2_FU_HPI_02 extends Controller
{
    ...
    function view_action($form_id)
    {
        if (is_numeric($form_id)) {
            $form = new FormDM2_FU_HPI_02($form_id);
        } else {
            $form = new FormDM2_FU_HPI_02();
        }
    ...
    function default_action_process()
    {
        ...
        $this->form = new FormDM2_FU_HPI_02($_POST['id']);
